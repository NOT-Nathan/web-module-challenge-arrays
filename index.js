...
function copy(copyOriginalFlavors){
   return copyOriginalFlavors = [...originalFlavors]
}    
console.log(copy())
...
function getFlavorByIndex(originalFlavors,index){
    return console.log(originalFlavors[index])
}
...
function removeFlavorByName(originalFlavors, flavorRemove){
    for ( i in originalFlavors){
      if(originalFlavors[i].includes(flavorRemove)){
        originalFlavors.splice(i,1)
      }
    }
    return console.log(originalFlavors.length)
    }
